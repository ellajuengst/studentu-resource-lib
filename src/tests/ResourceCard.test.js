...
test("Renders ResourceCard component", () => {
    render(<AuthContext.Provider value={value_user}><BrowserRouter><ResourceCard/></BrowserRouter></AuthContext.Provider>);
...
test("Renders edit resource link for admin", () => {
    render(<AuthContext.Provider value={value_admin}><BrowserRouter><ResourceCard/></BrowserRouter></AuthContext.Provider>);
